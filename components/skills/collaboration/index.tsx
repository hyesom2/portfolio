import { COLLABORATION_DATA } from '@/data/skillsData';
import Image from 'next/image';

export default function Collaboration() {
  return (
    <section>
      <h2 className='text-[32px] text-gray-500 font-bold mb-5'>협업 도구</h2>
      <ul className='grid grid-cols-1 gap-6 md:grid-cols-2'>
        {COLLABORATION_DATA.map(({ id, title, content, img_url }) => (
          <li
            key={id}
